...
const (
	flowBaseSpeed  = 32.3  // px/сек при нулевой нагрузке (медленно; на 5% медленнее)
	flowLoadSpeed  = 8.55  // +px/сек на каждый кВт (больше нагрузка → быстрее)
	flowMaxSpeed   = 114.0 // потолок скорости, px/сек
